...
// configurable parameters for Se rvo
...
#define _POS_START (_DUTY_NEU - ((_DUTY_MAX - _DUTY_MIN) / 4)) // servo start position
#define _POS_END   (_DUTY_NEU + ((_DUTY_MAX - _DUTY_MIN) / 4)) // servo end position
